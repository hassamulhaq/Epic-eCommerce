            ...
            const html = `<tr id="row_${counter}" class="row">
                        <td>
                            <div class="relative mb-3">
                                <input type="text" id="attribute_name_${counter}" name="attribute_name[]" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-indigo-500 focus:outline-none focus:border-indigo-600 peer" placeholder=" ">
                        ...
                        <td>
                            <div class="relative mb-3">
                                <input type="text" id="attribute_value_${counter}" name="attribute_value[]" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-indigo-500 focus:outline-none focus:border-indigo-600 peer" placeholder=" ">
